...
Column {
    ...
    Repeater {
        ...
        Rectangle {
            ...
            color: rArea.containsMouse ? (danger ? Qt.rgba(Theme.error.r, Theme.error.g, Theme.error.b, 0.16) : Theme.surfaceLight) : "transparent"
            Behavior on color { ColorAnimation { duration: Theme.shortDuration } }
            ...
            DankIcon {
                ...
                color: danger && rArea.containsMouse ? Theme.error : (rArea.containsMouse ? island.accent : island.textColor)
            }
            StyledText {
                anchors.left: rIco.right; anchors.leftMargin: Theme.spacingM; anchors.verticalCenter: parent.verticalCenter
                text: modelData.lbl; font.pixelSize: Theme.fontSizeSmall; font.bold: true
                color: danger && rArea.containsMouse ? Theme.error : island.textColor
            }
